...
mod bar {
    ...
    mod actions {
        ...
        pub(super) fn handle_back(app: &mut WizardApp) {
            ...
            if app.state.step1.have_weidu_logs
                && (app.state.current_step == 3 || app.state.current_step == 4)
            {
            ...
            .clicked()
    {
        ...
        pub(super) fn render_exit_button(
            ui: &mut egui::Ui,
            app: &mut WizardApp,
            step5_install_running: bool,
        ) {
                ...
                if app.state.current_step == 0 {
                    ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                        if ui
                            ...
                            .on_hover_text(
                                "Validate required paths and files for the selected game mode.",
                            )
                            .clicked()
                        {
