...
pub(in crate::app::controller) fn normalize_component_name(value: &str) -> String {
...
pub(in crate::app) fn parse_component_tp2_from_raw(raw: &str) -> Option<String> {
...
pub(in crate::app::controller) fn installed_component_display_name(
    installed: &Component,
) -> String {
...
pub(in crate::app::controller) fn tp2_compatible(
    child_tp2_norm: &str,
    target_tp2_norm: &str,
) -> bool {
...
pub(in crate::app::controller) fn is_eet_end_line(installed: &Component) -> bool {
...
pub(in crate::app::controller) fn try_apply_eet_end_fallback(
...
pub(in crate::app::controller) fn is_allowed_tp2(
    allow: &HashSet<String, RandomState>,
    installed: &Component,
) -> bool {
