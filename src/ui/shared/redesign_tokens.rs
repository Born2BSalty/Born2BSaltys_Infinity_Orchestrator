...
fn values(palette: ThemePalette) -> PaletteValues {
    match palette {
...
pub fn redesign_page_bg(palette: ThemePalette) -> egui::Color32 {
    values(palette).page_bg
}

pub fn redesign_shell_bg(palette: ThemePalette) -> egui::Color32 {
    values(palette).shell_bg
}

pub fn redesign_chrome_bg(palette: ThemePalette) -> egui::Color32 {
    values(palette).chrome_bg
}

pub fn redesign_rail_bg(palette: ThemePalette) -> egui::Color32 {
    values(palette).rail_bg
}

pub fn redesign_border_strong(palette: ThemePalette) -> egui::Color32 {
    values(palette).border_strong
}

pub fn redesign_border_soft(palette: ThemePalette) -> egui::Color32 {
    values(palette).border_soft
}

pub fn redesign_border_dashed_light(palette: ThemePalette) -> egui::Color32 {
    values(palette).border_dashed_light
}

pub fn redesign_text_primary(palette: ThemePalette) -> egui::Color32 {
    values(palette).text_primary
}

pub fn redesign_text_muted(palette: ThemePalette) -> egui::Color32 {
    values(palette).text_muted
}

pub fn redesign_text_faint(palette: ThemePalette) -> egui::Color32 {
    values(palette).text_faint
}

pub fn redesign_text_fainter(palette: ThemePalette) -> egui::Color32 {
    values(palette).text_fainter
}

pub fn redesign_text_on_accent(_palette: ThemePalette) -> egui::Color32 {
    egui::Color32::from_rgb(0x1a, 0x26, 0x38)
}

pub fn redesign_input_bg(palette: ThemePalette) -> egui::Color32 {
    values(palette).input_bg
}

pub fn redesign_shadow(palette: ThemePalette) -> egui::Color32 {
    values(palette).shadow
}

pub fn redesign_success(palette: ThemePalette) -> egui::Color32 {
    values(palette).success
}

pub fn redesign_status_dot(palette: ThemePalette) -> egui::Color32 {
    values(palette).status_dot
}

pub fn redesign_accent(palette: ThemePalette) -> egui::Color32 {
    values(palette).accent
}

pub fn redesign_accent_hover(palette: ThemePalette) -> egui::Color32 {
    values(palette).accent_hover
}

pub fn redesign_accent_deep(palette: ThemePalette) -> egui::Color32 {
    values(palette).accent_deep
}

pub fn redesign_pill_danger(_palette: ThemePalette) -> egui::Color32 {
    egui::Color32::from_rgb(0xe6, 0x9a, 0x96)
}

pub fn redesign_pill_warn(_palette: ThemePalette) -> egui::Color32 {
    egui::Color32::from_rgb(0xe8, 0xc4, 0x41)
}

pub fn redesign_pill_info(_palette: ThemePalette) -> egui::Color32 {
    egui::Color32::from_rgb(0xa8, 0xd2, 0xcc)
}

pub fn redesign_pill_neutral(_palette: ThemePalette) -> egui::Color32 {
    egui::Color32::from_rgb(0xc4, 0xca, 0xd1)
}

pub fn redesign_selection_highlight(palette: ThemePalette) -> egui::Color32 {
    values(palette).selection_highlight
}

pub fn redesign_selection_highlight_hover(palette: ThemePalette) -> egui::Color32 {
    values(palette).selection_highlight_hover
}

pub fn redesign_hover_overlay(palette: ThemePalette) -> egui::Color32 {
    values(palette).hover_overlay
}

pub fn redesign_text_disabled(palette: ThemePalette) -> egui::Color32 {
    values(palette).text_fainter
}

pub fn redesign_accent_path(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_accent_numbers(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_accent_comment(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_warning(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_warning_soft(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_error(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_prompt_text(_palette: ThemePalette) -> egui::Color32 {
    egui::Color32::from_rgb(0x28, 0x14, 0x00)
}

pub fn redesign_prompt_fill(_palette: ThemePalette) -> egui::Color32 {
    egui::Color32::from_rgb(0xf5, 0xc3, 0x5f)
}

pub fn redesign_prompt_stroke(_palette: ThemePalette) -> egui::Color32 {
    egui::Color32::from_rgb(0xd2, 0xa0, 0x46)
}

pub fn redesign_compat_included(palette: ThemePalette) -> egui::Color32 {
    redesign_text_faint(palette)
}

pub fn redesign_compat_included_fill(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_compat_conflict(palette: ThemePalette) -> egui::Color32 {
    redesign_error(palette)
}

pub fn redesign_compat_conflict_fill(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_compat_warning(palette: ThemePalette) -> egui::Color32 {
    redesign_warning(palette)
}

pub fn redesign_compat_warning_fill(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_compat_info(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_compat_info_fill(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_compat_mismatch(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_compat_mismatch_fill(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_compat_conditional(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_compat_conditional_fill(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_status_running(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_status_preparing(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_status_idle(palette: ThemePalette) -> egui::Color32 {
    redesign_text_muted(palette)
}

pub fn redesign_terminal_default(palette: ThemePalette) -> egui::Color32 {
    redesign_text_primary(palette)
}

pub fn redesign_terminal_error(palette: ThemePalette) -> egui::Color32 {
    redesign_error(palette)
}

pub fn redesign_terminal_debug(palette: ThemePalette) -> egui::Color32 {
    match palette {
...
pub fn redesign_terminal_sent(palette: ThemePalette) -> egui::Color32 {
    redesign_accent_numbers(palette)
}

pub fn redesign_terminal_info(palette: ThemePalette) -> egui::Color32 {
    redesign_status_running(palette)
}

pub fn redesign_terminal_amber(palette: ThemePalette) -> egui::Color32 {
    redesign_warning(palette)
}

pub fn redesign_terminal_sand(palette: ThemePalette) -> egui::Color32 {
    redesign_accent_path(palette)
}

pub fn redesign_terminal_dim(palette: ThemePalette) -> egui::Color32 {
    redesign_text_faint(palette)
}
