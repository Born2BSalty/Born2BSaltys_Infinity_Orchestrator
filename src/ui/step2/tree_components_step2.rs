...
use crate::ui::step2::format_step2::{colored_component_widget_text, format_component_row_label};
...
pub(crate) fn render_component_rows(
                    ...
                    |ui| {
                        ...
                        if !evaluated_prompt_summary.trim().is_empty() {
                            ...
                            if prompt_response.clicked() {
                                ...
                                open_prompt_popup = Some((
                                    format!("{} #{}", mod_state.tp_file, component.component_id),
    ...
    (new_selection, open_compat_for_component, open_prompt_popup)
}
