...
pub struct WizardApp {
    ...
    step2_update_download_rx: Option<Receiver<step2_update_download::Step2UpdateDownloadResult>>,
    step2_update_extract_rx: Option<Receiver<step2_update_extract::Step2UpdateExtractResult>>,
