...
pub(crate) fn update_prompt_readiness(
...
pub(crate) fn ready_for_scripted(state: &WizardState, now_ms: u64, debounce_ms: u64) -> bool {
...
pub(crate) fn ready_for_fallback(
    state: &WizardState,
    now_ms: u64,
    headers_ready: bool,
    debounce_ms: u64,
...
pub(crate) fn settle_active(state: &WizardState, now_ms: u64, post_send_delay_ms: u64) -> bool {
    state
        .step5
