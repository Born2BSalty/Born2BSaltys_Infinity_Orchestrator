...
pub(crate) fn render_status_and_input(
    ...
    crate::ui::step5::service_step5::auto_answer::try_auto_answer_prompt(state, terminal.as_deref_mut(), waiting_for_input_before);
    ...
    ui.horizontal_centered(|ui| {
        ...
        crate::ui::step5::service_step5::process_line::render_process_runtime_inline(ui, state, terminal.as_deref());
        crate::ui::step5::service_step5::process_line::render_error_copy(ui, state, terminal.as_deref());
    });
...
pub(crate) fn render_console(
    ...
    ui.group(|ui| {
        ...
        ui.label(crate::ui::shared::typography_global::section_title("Console"));
...
pub(super) fn render_phase(ui: &mut egui::Ui, state: &WizardState, phase: &PhaseInfo) {
    ...
    let phase_resp = ui.add(
        egui::Label::new(crate::ui::shared::typography_global::strong(phase_text).color(phase.color))
