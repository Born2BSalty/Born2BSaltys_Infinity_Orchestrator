...
- **`-u` per-component WeiDU-log folder** — the `weidu_component_logs/` directory [§13.12](#1312-automatic-flag-policies) #2 points `-u` at. Created per-install inside the destination, fixed name, not user-configurable.
