...
- **Where:** New files `src/ui/workspace/step2/mod.rs` + `workspace_step2.rs` (+ split helpers as needed: `step2_search`, `step2_tab_row`, `step2_dev_scan`, `step2_rescan_reconcile`). The router's Step 2 arm (P6.T2) calls this.
