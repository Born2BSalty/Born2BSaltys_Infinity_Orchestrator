...
**Commit anchors:** rolled in alongside the foundational redesign work; precise per-task commit map not separately captured in `decision-log.md` — see archive for task-level detail.
