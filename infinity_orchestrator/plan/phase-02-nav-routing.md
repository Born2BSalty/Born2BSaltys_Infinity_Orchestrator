...
**Commit anchors:** rolled in with the foundational redesign work alongside Phase 1; precise per-task commit map not separately captured in `decision-log.md` — see archive for task-level detail.
