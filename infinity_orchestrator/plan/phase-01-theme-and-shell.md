...
**Commit anchors:** rolled in with the early redesign baseline (`375342f` "Infinity Orchestrator redesign baseline", `562161b` "Overhaul"); precise per-task commit map not separately captured in `decision-log.md` — see archive for task-level detail.
